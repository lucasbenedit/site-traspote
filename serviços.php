<body>
    ...
    <body>
        ...
        <center>
            <img src="img/van131.jpg" style="width: 600px; height: 400px;">
            <h1>Transporte escolar</h1>

            <p>
                <!-- #region -->
                nós do trasporte escolar PX131
                trabalhamos com execelência pra mostra a combetecia de serviços para,
                os noosos clientes
            </p>
            <p>
                <!-- #region -->
                traz o seu filho para o trasporte escolar para ele ir para a escola com segurança
                e conforto
